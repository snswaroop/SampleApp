...
const EditStudentPage = (props) => {
    ...
    const updateFields = (key, value) => {
        ...
        dispatch({ type: 'UPDATE_STUDENT', payload: { key: key, value: value } })
    }
...
const mapToProps = (state) => {
    return {
        user: { id: state.studentReducer.id, userName: state.studentReducer.userName, firstName: state.studentReducer.firstName, lastName: state.studentReducer.lastName, telephone: state.studentReducer.telephone, emailId: state.studentReducer.emailId, aliasMailId: state.studentReducer.aliasMailId, skypeId: state.studentReducer.skypeId, password: state.studentReducer.password, address: state.studentReducer.address }
    }
}

export default connect(mapToProps)(EditStudentPage);