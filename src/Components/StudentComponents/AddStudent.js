...
const AddStudent = ({ navigation }) => {
    ...
    const onTextChange = (key, value) => {
        ...
        dispatch({ type: "ADD_STUDENT", payload: { key: key, value: value } })
    }
            ...
            <ScrollView style={{ position: 'relative' }}>
                <View style={{ flex: 1, paddingLeft: 10, paddingRight: 10, paddingTop: 15, marginBottom: 30 }}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            <TextInput style={{ fontSize: 18, borderBottomWidth: 1, borderBottomColor: '#C8C8C8' }} value={emailId} editable={true} onChangeText={(text) => { onTextChange('emailId', text) }} autoCapitalize={false} />
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            ...
                            {showErrorMessage ? <Text style={{fontSize: 14, color: '#000000', fontWeight: '700', marginTop: 10 }}>*Password cannot be empty.</Text> : false }
                        </View>
                    </View>
                </View>
            </ScrollView>
