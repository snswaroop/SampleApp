...
const EditInstructors = (props) => {
    ...
    const updateFields = (key, value) => {
        ...
        dispatch({ type: 'UPDATE_INSTRUCTOR', payload: { key: key, value: value } })
    }
...
const mapToProps = (state) => {
    return {
        user: { id: state.instructorReducer.id, userName: state.instructorReducer.userName, firstName: state.instructorReducer.firstName, lastName: state.instructorReducer.lastName, telephone: state.instructorReducer.telephone, emailId: state.instructorReducer.emailId, aliasMailId: state.instructorReducer.aliasMailId, skypeId: state.instructorReducer.skypeId, password: state.instructorReducer.password, address: state.instructorReducer.address }
    }
}


export default connect(mapToProps)(EditInstructors);