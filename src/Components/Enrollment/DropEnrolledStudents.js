...
const DropEnrolledStudents = ({ navigation }) => {
    ...
    const EnrolledStudents = (key, value) => {
        // dispatch({ type: 'ENROLL_STUDENTS', payload: { key: key, value: value } })
        console.log(key)
        dispatch({ type: 'DEENROLL_STUDENTS', payload: { id: key, studentId: value } })
    }
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, paddingLeft: 10, paddingRight: 10, paddingTop: 15, marginBottom: 30 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        {
                            ...
                            />
                                ...
                                <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: 'auto', marginBottom: 'auto' }}>
                                    <Text style={{ fontWeight: '600', fontSize: 18, color: '#333333' }}>No Students found. Please adjust the filter</Text>
                                </View>
                        }
                    ...
                    <TouchableOpacity style={[styles.buttonBlue, { position: 'absolute', bottom: 0 }]} onPress={onSubmitData}>
                        <Text style={[styles.textWhite]}>Disenroll</Text>
                    </TouchableOpacity>
...
export default DropEnrolledStudents