...
const AddAdmin = ({ navigation }) => {
    ...
    const onTextChange = (key, value) => {
        ...
        dispatch({ type: "ADD_ADMIN", payload: { key: key, value: value } })
    }
            ...
            <ScrollView style={{ position: 'relative' }}>
                <View style={{ flex: 1, paddingLeft: 10, paddingRight: 10, paddingTop: 15 }}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            <TextInput style={{ fontSize: 18, borderBottomWidth: 1, borderBottomColor: '#C8C8C8' }} value={emailId} editable={true} onChangeText={(text) => { onTextChange('emailId', text) }} autoCapitalize={false} autoCorrect={false} />
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            <TextInput style={{ fontSize: 18, borderBottomWidth: 1, borderBottomColor: '#C8C8C8' }} value={altEmail} editable={true} onChangeText={(text) => { onTextChange('aliasMailId', text) }} autoCapitalize={false} autoCorrect={false} />
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            <TextInput style={{ fontSize: 18, borderBottomWidth: 1, borderBottomColor: '#C8C8C8' }} value={skypeId} editable={true} onChangeText={(text) => { onTextChange('skypeId', text) }} autoCapitalize={false} autoCorrect={false} />
                    ...
                    <View style={{ width: '100%', flexDirection: 'row', marginTop: 25 }}>
                        ...
                        <View style={{ flex: 3, justifyContent: 'center' }}>
                            <TextInput style={{ fontSize: 18, borderBottomWidth: 1, borderBottomColor: '#C8C8C8' }} value={address} editable={true} onChangeText={(text) => { onTextChange('address', text) }} autoCapitalize={false} autoCorrect={false} />
